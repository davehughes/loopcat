...
DEFAULT_PORT_NAME = "Gridcat"


class MidiEngine:
    """MIDI output engine for sending notes."""
    ...
    def all_notes_off(self) -> None:
        """Send all notes off (CC 123) on current channel."""
        if self.output:
            msg = mido.Message(
